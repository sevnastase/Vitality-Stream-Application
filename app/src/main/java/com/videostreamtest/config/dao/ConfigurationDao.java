...
public interface ConfigurationDao {
    ...
    @Query("UPDATE configuration_table SET local_play = :localPlay," +
            "boot_on_start = :bootOnStart," +
            "communication_device = :communicationDevice," +
            "update_praxcloud = :updateFromPraxCloud," +
            "praxcloud_mediaserver_url = :mediaServerUrl," +
            "praxcloud_mediaserver_local_url = :localMediaServerUrl," +
            "account_type = :accountType " +
            "WHERE is_current")
    int updateCurrentConfiguration(boolean localPlay, boolean bootOnStart, String communicationDevice, boolean updateFromPraxCloud, String mediaServerUrl, String localMediaServerUrl, String accountType);
}
